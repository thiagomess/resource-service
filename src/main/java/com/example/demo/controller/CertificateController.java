...
public class CertificateController {
    ...
    private static final Logger logger = org.slf4j.LoggerFactory.getLogger(CertificateController.class);
    ...
    @PreAuthorize("oauth2.hasScope('certificate')")
    @GetMapping(value = "/certificate/internal", produces = "application/json")
    @ResponseStatus(value = HttpStatus.OK)
    public ResponseEntity<Object> getCertificate(HttpServletRequest req) throws MalformedURLException {
