...
public class BankAccountsController {
    ...
    private static final Logger logger = org.slf4j.LoggerFactory.getLogger(BankAccountsController.class);
    ...
    @PreAuthorize("oauth2.hasScope('bankaccounts')")
    @GetMapping(value = "/bank/accounts", produces = "application/json")
    @ResponseStatus(value = HttpStatus.OK)
    public ResponseEntity<Object> getAccounts(HttpServletRequest req) throws MalformedURLException {
