...
public class AnticipationController {
    ...
    private static final Logger logger = org.slf4j.LoggerFactory.getLogger(AnticipationController.class);
    ...
    @PreAuthorize("oauth2.hasScope('anticipation')")
    @GetMapping(value = "/anticipation/data", produces = "application/json")
    @ResponseStatus(value = HttpStatus.OK)
    public ResponseEntity<Object> getAnticipation(HttpServletRequest req) throws MalformedURLException {
