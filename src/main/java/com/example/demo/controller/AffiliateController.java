...
public class AffiliateController {
    ...
    private static final Logger logger = org.slf4j.LoggerFactory.getLogger(AffiliateController.class);
    ...
    @PreAuthorize("oauth2.hasScope('affiliate')")
    @GetMapping(value = "/affiliate/info", produces = "application/json")
    @ResponseStatus(value = HttpStatus.OK)
    public ResponseEntity<Object> getAffiliate(HttpServletRequest req) throws MalformedURLException {
