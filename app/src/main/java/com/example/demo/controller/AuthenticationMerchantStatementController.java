...
public class AuthenticationMerchantStatementController {
    ...
    @PreAuthorize("oauth2.hasScope('merchantstatement')")
    @GetMapping(value = "/merchant/statement", produces = "application/json")
    @ResponseStatus(value = HttpStatus.OK)
    public ResponseEntity<Object> getStatement(HttpServletRequest req) throws MalformedURLException {
